...
각 아이템마다: 한 줄 요약, 핵심 방법론(핵심적인 내용이 반드시 포함되어야만하고 디테일하게 서술하되 최대 5문장), 기존 대비 차별점, 왜 중요한가
...
- 내용은 트랜드와 해당 트랜드에 해당하는 논문의 내용에 충실해야 하며 핵심적인 내용이 포함되어야 함
- 각 트렌드 3~4문장으로 너무 길지 않게 작성할 것
- 단순 나열이 아니라 왜 이들이 같은 흐름인지 해석할 것
